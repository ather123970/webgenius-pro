...
export default function WebAppsPage() {
    const service = SERVICES.find((s: any) => s.id === 'web-apps');
            ...
            <main className="min-h-screen pt-24">
                ...
                <section className="section-padding bg-gradient-to-br from-blue-50 via-white to-purple-50">
                    <div className="container-custom">
                        ...
                        <Link
                            href="/#services"
                            className="inline-flex items-center gap-2 text-gray-600 hover:text-blue-600 mb-8 font-semibold transition-colors"
                        >
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            >
                                ...
                                <div className="flex flex-wrap gap-4">
                                    ...
                                    <Link
                                        href="/#contact"
                                        className="inline-flex items-center gap-2 px-8 py-4 bg-white border-2 border-gray-200 text-gray-900 rounded-xl font-bold hover:border-blue-300 transition-all hover:scale-105"
                                    >
                    ...
                    <div className="container-custom text-center">
                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-4 justify-center">
                                <Link
                                    href="/#order"
                                    className="inline-flex items-center gap-2 px-8 py-4 bg-white text-blue-600 rounded-xl font-bold hover:shadow-xl transition-all hover:scale-105"
                                >
                                    Start Your Project
                                    <FiArrowRight className="w-5 h-5" />
                                </Link>
                                <Link
                                    href="/#services"
                                    className="inline-flex items-center gap-2 px-8 py-4 bg-transparent border-2 border-white text-white rounded-xl font-bold hover:bg-white hover:text-blue-600 transition-all"
                                >
                                    View All Services
                                </Link>
                            </div>
