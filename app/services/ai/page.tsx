...
export default function AIPage() {
    const service = SERVICES.find((s: any) => s.id === 'ai');
            ...
            <main className="min-h-screen pt-24">
                <section className="section-padding bg-gradient-to-br from-indigo-50 via-white to-blue-50">
                    <div className="container-custom">
                        <Link
                            href="/#services"
                            className="inline-flex items-center gap-2 text-gray-600 hover:text-indigo-600 mb-8 font-semibold transition-colors"
                        >
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
                                ...
                                <div className="flex flex-wrap gap-4">
                                    ...
                                    <Link href="/#contact" className="inline-flex items-center gap-2 px-8 py-4 bg-white border-2 border-gray-200 text-gray-900 rounded-xl font-bold hover:border-indigo-300 transition-all hover:scale-105">
                ...
                <section className="section-padding bg-gradient-to-br from-indigo-600 to-blue-600 text-white">
                    <div className="container-custom text-center">
                        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                            <h2 className="text-4xl md:text-5xl font-black mb-6">Ready to Get Started?</h2>
                            <p className="text-xl mb-8 text-indigo-100 max-w-2xl mx-auto">Let's build something amazing together. Schedule a free consultation to discuss your project.</p>
                            <div className="flex flex-wrap gap-4 justify-center">
                                <Link href="/#order" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-indigo-600 rounded-xl font-bold hover:shadow-xl transition-all hover:scale-105">
                                    Start Your Project
                                    <FiArrowRight className="w-5 h-5" />
                                </Link>
                                <Link href="/#services" className="inline-flex items-center gap-2 px-8 py-4 bg-transparent border-2 border-white text-white rounded-xl font-bold hover:bg-white hover:text-indigo-600 transition-all">
                                    View All Services
                                </Link>
                            </div>
                        </motion.div>
